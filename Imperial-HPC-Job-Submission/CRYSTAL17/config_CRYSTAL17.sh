...
function set_commands {
    ...
    echo "alias Pcrys17='$(dirname $0)/gen_sub -x pcrys -set ${SCRIPTDIR}/settings'" >> ${HOME}/.bashrc
    echo "alias MPPcrys17='$(dirname $0)/gen_sub -x mppcrys -set ${SCRIPTDIR}/settings'" >> ${HOME}/.bashrc
    echo "alias Pprop17='$(dirname $0)/gen_sub -x pprop -set ${SCRIPTDIR}/settings'" >> ${HOME}/.bashrc
    echo "alias Scrys17='$(dirname $0)/gen_sub -x scrys -set ${SCRIPTDIR}/settings'" >> ${HOME}/.bashrc
    echo "alias Sprop17='$(dirname $0)/gen_sub -x sprop -set ${SCRIPTDIR}/settings'" >> ${HOME}/.bashrc
    echo "alias Xcrys17='$(dirname $0)/gen_sub -set ${SCRIPTDIR}/settings'" >> ${HOME}/.bashrc
